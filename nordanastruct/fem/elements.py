...
from nordanastruct.basic import FEMException

if TYPE_CHECKING:
    from nordanastruct.fem.node import Node
    from nordanastruct.fem.system import Spring
    from nordanastruct.types import ElementType
    from nordanastruct.vertex import Vertex

try:
    from nordanastruct.fem.cython.celements import (  # pylint: disable=unused-import
        det_axial,
        det_moment,
        det_shear,
    )
except ImportError:
    from nordanastruct.fem.cython.elements import det_axial, det_moment, det_shear
